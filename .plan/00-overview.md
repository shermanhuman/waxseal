...
- Provision GCP resources via `waxseal gcp bootstrap` (interactive wizard, no click-ops).
  - v1: implemented in Go, cross-platform (Windows/macOS/Linux).
  - Always interactive — no flags beyond global `--dry-run`.
